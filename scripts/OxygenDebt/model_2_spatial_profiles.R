...
# fit gams
what <- c("sali_surf", "sali_dif", "halocline", "depth_gradient", "O2def_below_halocline")

fitfunc1 <-  function(what) {
...
# save
save(gams, file = file.path(dirmain, "analysis/output/OxygenDebt/gam_fits.RData"))
